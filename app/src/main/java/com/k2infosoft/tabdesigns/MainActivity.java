...
import com.k2infosoft.tabdesigns.coordinatortab.CoordinatorActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    @BindView(R.id.action_coordinatortab)
    com.k2infosoft.k2floatingbutton.FloatingTextButton mcordinatortab1;
    ...
    @OnClick(R.id.action_coordinatortab)
    public void setMcordinatortab1(View view) {
